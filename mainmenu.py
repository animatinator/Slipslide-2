...
The Penuine main menu class, copyright David Barker 2008.
    ...
    Update the text objects' positions.
        ...
        self.item2pos = self.item1pos + self.item1rect.width + spacing
        self.item3pos = self.item2pos + self.item2rect.width + spacing
        self.item4pos = self.item3pos + self.item3rect.width + spacing
